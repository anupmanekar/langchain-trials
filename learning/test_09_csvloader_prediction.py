...
loader = CSVLoader(file_path='/Users/anupmanekar/DevWorkspace/stock-market-data/NIFTY 50_Data.csv', source_column='Date', csv_args={
    'delimiter': ',',
    'quotechar':'"',
...
model = ChatOllama(max_tokens=256)
